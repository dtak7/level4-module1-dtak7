...
public class Snake {
	...
	public boolean isOutOfBounds() {
		...
		//   and false otherwise
		if(head.getLocation().x>_00_SnakeGame.WIDTH-1||head.getLocation().x<-1||head.getLocation().y<-1||head.getLocation().y>_00_SnakeGame.HEIGHT-1) {
			return true;
		}
		return false;
	}
